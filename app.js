...
const translations = {
  ko: {
    ...
    optionalPlaceholderValue: "해당 시 입력",
    emailLabel: "이메일",
    addressLabel: "주소",
  ...
  en: {
    ...
    mailOrderLabel: "Mail-order sales registration",
    optionalPlaceholderValue: "If applicable",
    emailLabel: "Email",
  ...
  ja: {
    ...
    mailOrderLabel: "通信販売業届出番号",
    optionalPlaceholderValue: "該当する場合に入力",
    emailLabel: "メール",
    addressLabel: "住所",
    addressValue: "경기도 용인시 수지구 현암로 148, 1동 6층 602호 -C30(죽전동, 죽전스카이프라자)",
    footerNote: "© 2026 Canvas Lab. All rights reserved.",
  ...
  zh: {
    ...
    mailOrderLabel: "通信销售备案号",
    optionalPlaceholderValue: "如适用",
    emailLabel: "电子邮件",
    addressLabel: "地址",
    addressValue: "경기도 용인시 수지구 현암로 148, 1동 6층 602호 -C30(죽전동, 죽전스카이프라자)",
    footerNote: "© 2026 Canvas Lab. All rights reserved.",
  ...
  fr: {
    ...
    mailOrderLabel: "Déclaration de vente à distance",
    optionalPlaceholderValue: "Si applicable",
    emailLabel: "E-mail",
  ...
  es: {
    ...
    mailOrderLabel: "Registro de venta a distancia",
    optionalPlaceholderValue: "Si aplica",
  ...
  de: {
    ...
    mailOrderLabel: "Fernabsatz-/Onlinehandel-Registrierung",
    optionalPlaceholderValue: "Falls zutreffend",
    emailLabel: "E-Mail",
    addressLabel: "Adresse",
    addressValue: "경기도 용인시 수지구 현암로 148, 1동 6층 602호 -C30(죽전동, 죽전스카이프라자)",
    footerNote: "© 2026 Canvas Lab. All rights reserved.",
